...
public class PurchaseServletTest {
    ...
    public void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field userDaoField = purchaseServlet.getClass().getDeclaredField("userDao");
        userDaoField.setAccessible(true);
        userDaoField.set(purchaseServlet, userDao);
    ...
    public void doPost_Should_CreateOrder_When_EverythingIsFine() throws ServletException, IOException {
        ...
        verify(orderDao, times(1)).save(eq(user.getId()), any());
    ...
    @Test
    public void doPost_Should_ThrowServletException_When_UserNotFound() throws ServletException {
        when(request.getParameter("overall")).thenReturn("1.0");
        Session session = new Session();
        session.setExpirationTime(LocalDateTime.MAX);
        session.setUserId(1L);
